...
def get_hfw():
    word_file = open('./../text_based_analysis/market_analysis/statistic_result/microwave.txt', 'r')
    res = list()
...
def get_adj():
    word_file = open('./../text_based_analysis/market_analysis/statistic_result/microwave_a.txt', 'r')
    res_p = list()
    res_n = list()
    for word in word_file.readlines():
        is_positive = False
...
def get_sentence(product_title):
    table = get_dataframe("/Users/Miao/Downloads/2020_Weekend2_Problems/Problem_C_Data/microwave.tsv")
...
# main()
# compute_vector()
# get_sentence("samsung smh1816s 1.8 cu. ft. stainless steel over-the-range microwave")
main()